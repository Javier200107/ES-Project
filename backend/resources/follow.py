...
class Follow(Resource):
    ...
    def get(self, account1, account2=None):
        ...
        if (acc1 and acc2):
            ...
            if (follows):
                for i in follows:
                    if (i.id == acc2.id):
                        return {'message': "Account1 follows Account2 [{}] ".format(account1,
                                                                                    account2)}, 200 if i else 404
            ...
            return {'message': "Account [{}] or [{}] doesn't exists".format(account1, account2)}, 404
    @auth.login_required()
    def post(self, account1, account2=None):
        ...
        if (acc1 and acc2):
            ...
            if (follow):
                for i in follow:
                    if (i.id == acc2.id):
                        ...
                        return {'message': "Account1 [{}] already follows Account2 [{}]".format(account1,
                                                                                                account2)}, 404
            follow.append(acc2)
            try:
                acc1.save_to_db()
            ...
            return {'message': "Account1 [{}] or Account2 [{}] doesn't exists".format(account1, account2)}, 404
        ...
        with lock.lock:
            ...
            if (acc1 and acc2):
                ...
                if (follow):
                    ...
                    return {'message': "Follow with  [{}] and [{}] doesn't exists".format(account1, account2)}, 404
                else:
...
class ListFollows(Resource):
    ...
    def get(self,account=None):
        ...
        if (acc):
            ...
            return {'message': "Account [{}] doesn't exists".format(account)}, 404
