...
class AccountsModel(db.Model):
    ...
    def __init__(self, username, email,nom,cognom,datan, is_admin=0):
    ...
    def json(self):
        return{'username': self.username, 'email': self.email, 'nom': self.nom, 'surname': self.surname, 'bith': self.birth,  'is_admin': self.is_admin,}
